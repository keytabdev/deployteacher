...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 50026)), "C:\\Users\\Avinash\\Downloads\\temp\\app\\dashboard\\user-answers\\page.tsx"],
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 94363)), "C:\\Users\\Avinash\\Downloads\\temp\\app\\error.tsx"],
    ...
    const pages = ["C:\\Users\\Avinash\\Downloads\\temp\\app\\dashboard\\user-answers\\page.tsx"];

    

    const originalPathname = "/dashboard/user-answers/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/dashboard/user-answers/page","pathname":"/dashboard/user-answers","bundlePath":"app/dashboard/user-answers/page","filename":"","appPaths":[]}}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 97506))
...
;// CONCATENATED MODULE: ./services/user-answer/UserAnswerService.ts

class UserAnswerService {
    static async getUserAnswers(token, query) {
        const res = await axios/* default */.Z.get(`/user-answers?${query ? query : ""}`, {
            headers: {
    ...
    static async getByID(token, id) {
        const res = await axios/* default */.Z.get(`/user-answers/${id}?populate=*`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
    ...
    static async deleteByID(token, id) {
        const res = await axios/* default */.Z.delete(`/user-answers/${id}`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
...
/* harmony default export */ const user_answer_UserAnswerService = (UserAnswerService);
...
;// CONCATENATED MODULE: ./app/dashboard/user-answers/useUserAnswers.ts
...
function useUserAnswers(token) {
    ...
    const userAnswerQuery = qs_lib_default().stringify({
        sort: [
            "createdAt:desc"
        ],
        pagination: {
    ...
    const { data: answers, isLoading } = (0,lib.useQuery)([
        "user-answers",
        debounceQuery,
        page
    ], ()=>user_answer_UserAnswerService.getUserAnswers(token, userAnswerQuery), {
        onError: ()=>dist/* default */.ZP.error("something went wrong please try again after refreshing")
    });
    async function deleteUserAnswer(id) {
        return user_answer_UserAnswerService.deleteByID(token, id);
    }
    return {
        deleteUserAnswer,
        answers,
...
;// CONCATENATED MODULE: ./app/dashboard/user-answers/UserAnswers.tsx
...
function UserAnswers({ token }) {
    const { deleteUserAnswer, answers, isLoading, query, setQuery, page, setPage } = useUserAnswers(token);
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ jsx_runtime_.jsx("tbody", {
                                    ...
                                    children: isLoading ? /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                    ...
                                    }) : answers?.data && answers.data.length > 0 ? (answers?.data.map(({ id, attributes })=>{
                                        const { is_correct, question_id, user_quiz_id, createdAt } = attributes;
                                        return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("tr", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                                    className: "p-4 text-left",
                                                    children: question_id.data.id
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                                    className: "p-4 text-left",
                                                    children: user_quiz_id.data.id
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                                    className: "p-4 text-left",
                                                    children: is_correct ? "true" : "false"
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                                    className: "p-4 text-left",
                                        ...
                                        colSpan: 6,
                                        className: "p-4 text-center",
                                        children: "No user answers found"
                                    })
                                })
                            ]
                        })
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx(PaginatedCount/* default */.Z, {
                        page: page,
                        pageCount: answers?.meta.pagination.pageCount || 1,
                        setPage: setPage
                    })
                ]
            })
...
const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\Avinash\Downloads\temp\app\dashboard\user-answers\UserAnswers.tsx`)
...
/* harmony default export */ const UserAnswers = (__default__);
;// CONCATENATED MODULE: ./app/dashboard/user-answers/page.tsx
...
async function page() {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: /*#__PURE__*/ jsx_runtime_.jsx(UserAnswers, {
            token: session?.token
        })
    });
}
...
var __webpack_exports__ = __webpack_require__.X(0, [2669,525,659,7777,3962,3928,248,7287,3803,7370,8660,2949,551,3426,4824], () => (__webpack_exec__(80002)));
