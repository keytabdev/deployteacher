...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 765)), "C:\\Users\\Avinash\\Downloads\\temp\\app\\dashboard\\progresses\\page.tsx"],
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 94363)), "C:\\Users\\Avinash\\Downloads\\temp\\app\\error.tsx"],
    ...
    const pages = ["C:\\Users\\Avinash\\Downloads\\temp\\app\\dashboard\\progresses\\page.tsx"];

    

    const originalPathname = "/dashboard/progresses/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/dashboard/progresses/page","pathname":"/dashboard/progresses","bundlePath":"app/dashboard/progresses/page","filename":"","appPaths":[]}}
...
;// CONCATENATED MODULE: ./services/progresses/ProgresService.ts

class ProgressService {
    static async getProgresses(token, query) {
        const res = await axios/* default */.Z.get(`/progresses?${query ? query : ""}`, {
            headers: {
    ...
    static async getByID(token, id) {
        const res = await axios/* default */.Z.get(`/progresses/${id}?populate=*`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
    ...
    static async deleteByID(token, id) {
        const res = await axios/* default */.Z.delete(`/progresses/${id}`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
...
/* harmony default export */ const ProgresService = (ProgressService);
...
;// CONCATENATED MODULE: ./app/dashboard/progresses/useProgresses.ts
...
function useProgresses(token) {
    ...
    const progressQuery = qs_lib_default().stringify({
        sort: [
            "createdAt:desc"
        ],
        pagination: {
    ...
    const { data: progresses, isLoading } = (0,lib.useQuery)([
        "progresses",
        debounceQuery,
        page
    ], ()=>ProgresService.getProgresses(token, progressQuery), {
        onError: ()=>dist/* default */.ZP.error("something went wrong please try again after refreshing")
    });
    async function deleteProgress(id) {
        return ProgresService.deleteByID(token, id);
    }
    return {
        deleteProgress,
        progresses,
...
;// CONCATENATED MODULE: ./app/dashboard/progresses/Progresses.tsx
...
function Progresses({ token }) {
    const { deleteProgress, progresses, isLoading, query, setQuery, page, setPage } = useProgresses(token);
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ jsx_runtime_.jsx("tbody", {
                                    ...
                                    children: isLoading ? /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                    ...
                                    }) : progresses?.data && progresses.data.length > 0 ? (progresses?.data.map(({ id, attributes })=>{
                                        const { course_id, user_id, completion_status, progress_percent } = attributes;
                                        return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("tr", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                                    className: "p-4 text-left",
                                                    children: course_id.data.attributes.title
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                                    className: "p-4 text-left",
                                                    children: completion_status
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                                    className: "p-4 text-left",
                                                    children: progress_percent
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx(PaginatedCount/* default */.Z, {
                        page: page,
                        pageCount: progresses?.meta.pagination.pageCount || 1,
                        setPage: setPage
                    })
                ]
            })
...
const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\Avinash\Downloads\temp\app\dashboard\progresses\Progresses.tsx`)
...
/* harmony default export */ const Progresses = (__default__);
;// CONCATENATED MODULE: ./app/dashboard/progresses/page.tsx
...
async function page() {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: /*#__PURE__*/ jsx_runtime_.jsx(Progresses, {
            token: session?.token
        })
    });
}
...
var __webpack_exports__ = __webpack_require__.X(0, [2669,525,659,7777,3962,3928,248,7287,3803,8660,2949,551,3426,4824], () => (__webpack_exec__(67053)));
